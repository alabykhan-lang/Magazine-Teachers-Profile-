...
.mag-page-shell{position:relative;z-index:1;flex:1;display:flex;flex-direction:column;padding:58px 72px 66px;min-height:100%;}
.mag-horizon-page::before{content:'';position:absolute;left:-245px;top:-205px;width:620px;height:620px;border:36px solid var(--mag-gold);border-right-color:transparent;border-bottom-color:transparent;border-radius:50%;opacity:.96;}
.mag-horizon-page::after{content:'';position:absolute;right:-228px;bottom:-220px;width:610px;height:610px;border:34px solid var(--mag-gold);border-left-color:transparent;border-top-color:transparent;border-radius:50%;opacity:.96;}
.mag-horizon-curve-top,.mag-horizon-curve-bottom{position:absolute;border-radius:50%;pointer-events:none;z-index:0;}
.mag-horizon-curve-top{left:-190px;top:-152px;width:575px;height:575px;border:10px solid var(--mag-emerald);border-right-color:transparent;border-bottom-color:transparent;}
.mag-horizon-curve-bottom{right:-174px;bottom:-162px;width:535px;height:535px;border:10px solid var(--mag-emerald);border-left-color:transparent;border-top-color:transparent;}
...
.mag-footer-fixed{position:absolute;left:40px;right:40px;bottom:20px;height:34px;border-top:2px solid var(--mag-emerald);display:flex;align-items:flex-end;justify-content:space-between;background:transparent;z-index:4;}
...
.mag-inside-head{text-align:center;margin-top:-10px;margin-bottom:34px;}.mag-inside-logo{width:126px;height:126px;border:1px solid var(--mag-gold);border-radius:50%;margin:0 auto 18px;display:flex;align-items:center;justify-content:center;color:var(--mag-charcoal);font-size:13px;background:rgba(255,255,255,.25);box-shadow:0 0 0 7px rgba(214,168,79,.08);overflow:hidden;}.mag-inside-logo img{width:100%!important;height:100%!important;object-fit:contain!important;}.mag-inside-head h1{font-size:52px;line-height:1.05;color:var(--mag-navy);margin:0 0 16px;text-transform:uppercase;}.mag-gold-rule{height:1px;background:var(--mag-gold);width:320px;margin:0 auto;position:relative;}.mag-gold-rule::after{content:'';position:absolute;left:50%;top:-5px;width:10px;height:10px;background:var(--mag-gold);transform:translateX(-50%) rotate(45deg);}.mag-inside-location{font-size:20px;color:var(--mag-emerald);margin-top:16px;font-weight:700;}.mag-inside-meta{font-size:17px;color:var(--mag-gold);letter-spacing:.8px;margin-top:12px;font-weight:700;}.mag-inside-body{display:flex;flex-direction:column;gap:34px;position:relative;align-items:center;}.mag-inside-panel{width:83%;position:relative;border:1px solid rgba(214,168,79,.74);background:rgba(255,255,255,.34);break-inside:avoid;page-break-inside:avoid;}.mag-philosophy-panel{border-radius:0 22px 22px 22px;padding:42px 58px 30px;}.mag-anthem-panel{border-radius:0 0 14px 14px;background:rgba(232,238,246,.62);padding:40px 58px 34px;}.mag-panel-icon{position:absolute;left:-1px;top:-36px;width:78px;height:78px;border:1px solid rgba(214,168,79,.84);border-radius:50%;background:var(--mag-ivory);display:flex;align-items:center;justify-content:center;color:var(--mag-gold);font-family:'Playfair Display',serif;font-size:38px;line-height:1;}.mag-panel-icon.anthem{font-size:42px;}.mag-inside-title{text-align:center;font-size:27px;color:var(--mag-navy);margin:0 0 22px;text-transform:uppercase;}.mag-inside-title::after{content:'';display:block;width:270px;height:1px;background:var(--mag-gold);margin:9px auto 0;}.mag-inside-title::before{content:'';display:block;width:9px;height:9px;background:var(--mag-gold);margin:0 auto 9px;transform:rotate(45deg);}.mag-philosophy-text{font-size:13.6px;line-height:1.82;color:var(--mag-charcoal);text-align:left;}.mag-anthem-text{font-family:'Crimson Text',serif;font-size:19px;line-height:1.32;color:var(--mag-navy);font-style:italic;text-align:center;white-space:pre-line;}.mag-placeholder-lines{background:repeating-linear-gradient(to bottom,transparent 0,transparent 22px,rgba(31,41,51,.45) 23px,transparent 24px);min-height:118px;}
...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important;color-adjust:exact!important;}
    ...
    .mag-opening-page{width:100%!important;min-height:${h}px!important;height:${h}px!important;overflow:hidden!important;}
